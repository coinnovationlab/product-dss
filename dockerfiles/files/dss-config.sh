...
xml_append 'Parameter' "${AAC_HOSTNAME}/userroles/client" '//_:Authenticators/_:Authenticator[@name="OAUTH2SSOAuthenticator"]/_:Config/_:Parameter[@name="ApiKeyCheckURL"]' "${conf_path}/${conf_file}" 'name=APIClientRoleInfoURL'
xml_append 'Parameter' "profile.basicprofile.me profile.accountprofile.me user.roles.me user.roles.read" '//_:Authenticators/_:Authenticator[@name="OAUTH2SSOAuthenticator"]/_:Config/_:Parameter[@name="ApiKeyCheckURL"]' "${conf_path}/${conf_file}" 'name=ScopesListUserInfo'
